...
train_cases_know = get_kg(train_cases_tags, memes_know)
...
val_cases_know = get_kg(val_cases_tags, memes_know)
...
x_train = bert_tokenizer.__call__(
    list(train_cases_texts.values()), list(train_cases_know.values()),
    max_length = max_len,
    padding=True,
    truncation=True,
...
x_val = bert_tokenizer.__call__(
    list(val_cases_texts.values()), list(val_cases_know.values()),
    max_length = max_len,
    padding=True,
    truncation=True,
    return_token_type_ids = True,
...
for k in range(len(seeds)):
    ...
    model_name = "txt_bert_kg_" + "automatic" + str(k + 1)
